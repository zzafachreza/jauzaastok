...
export default function StokIn({ navigation, route }) {
    ...
    return (
        <SafeAreaView style={{
            ...
            <MyHeader judul="Stok Masuk" onPress={() => navigation.goBack()} />
            <View style={{
                flexDirection: 'row',
                padding: 10,
            }}>
                            ...
                            <View style={{
                                ...
                                <MyButton onPress={() => {
                                    ...
                                    axios.post(apiURL + 'stok_update', {
                                        ...
                                        showMessage({
                                            type: 'success',
                                            message: 'Stok masuk berhasil di update !'
                                        })
                                    })
                                    setOpen(false);
                                    setTimeout(() => {
